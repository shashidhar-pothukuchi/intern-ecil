          ...
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <div class="text-center" style="margin-top: 50px">
                  <a href="http://localhost:8084/viewvotes.jsp"<button class="btn btn-primary">View votes</button></a></div>
              <div align="center" style="margin-top: 50px">
              <table width="60%" class="table">
               <tr style="margin-bottom: 20px">
                 <td align="center"><h5>Party Name</h5></td>
                   <td align="center"><h5>Total Votes</h5></td>
               ...
               <tbody>
                   <%
                        ...
                        while(rs.next())
                        {
                            ...
                            ResultSet rns=snt.executeQuery("Select Count(partyname) from countr where partyname='"+rs.getString(1)+"'");
                            rns.next();
                        %>
<tr>
    <td align="center"><%=rs.getString(1)%></td>
    <td align="center"><%=rns.getString(1)%></td>
