...
<body style="background-image: url(img/unsplash-pillar.jpg); background-repeat: no-repeat;background-size: 1500px 1000px;">
        ...
        <div class="col-md-4 mx-auto">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Delete a Party</h2>
              
              <form action="partydel.jsp" method="post">
  <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Party Name</label>
  <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="partyname">
  ...
  <div class="text-center" style="margin:30px">
   <button type="submit" style="" class="btn btn-primary">Delete</button>
  </div>
</form>
            </div>
          </div>
