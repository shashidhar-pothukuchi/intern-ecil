...
<body id="page-top">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Aadhar Based,Party List,User Login</span><strong class="text-slider"></strong></p>
  ...
  <!--/ Section Services Star /-->
   <div class="intro route bg-image" style="background-image: url(img/overlay-bg.jpg); margin-bottom: 0px;">
  <section id="service" class="services-mf route">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            <h3 class="title-a title-left" style="color: white">
              Support
            </h3>
              <br/>
            <p class="subtitle-a" style="color: white">
              Aadhaar Based Online Voting System is meant for providing solution for the Election campaign.
              Election Campaign means canvassing the party agenda, policies,and structure of the party 
              details to the people. Aadhaar Based Online Voting System is aimed at assisting the Election 
              Commission of India in conducting and monitoring the Indian Elections.By introducing these 
              system you can save your valuable time.
            </p>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mx-auto">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Contact Details</h2>
              <p class="s-description text-center">
                K.SAKETH<br/>
